...
var REQ =
    {
        ...
        , "webMethod": function (url: string, method: string, onSuccess: (...args) => any, onError: (...args) => any, onDone: (...args) => any, postData, addParams?)
        {
            var url: string = url + "/" + method;
        ...
        , "get": function (url: string, onSuccess: (...args) => any, postData)
        {
            this.sendRequest(url, onSuccess, null, null, postData, 'application/urlencode', "GET");
        }

        , "post": function (url: string, onSuccess: (...args) => any, postData: (...args) => any, contentType?)
        {
            this.sendRequest(url, onSuccess, null, null, postData, 'application/x-www-form-urlencoded', "POST");
        }

        , "postJSON": function (url: string, onSuccess: (...args) => any, postData?, contentType?)
        {
            this.sendRequest(url, onSuccess, null, null, postData, 'application/json; charset=UTF-8', "POST");
        }

        , "sendRequest": function (url: string, onSuccess: (...args) => any, onError: (...args) => any, onDone: (...args) => any, postData, contentType, method)
        {
...
var HtmlTools =
    {
        ...
        , "popDrop": function (sel:any, data:any)
        {
            // console.log(data);

            if (typeof sel === 'string' || sel instanceof String)
                sel = document.getElementById(<string>sel);
